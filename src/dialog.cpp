...
dialog::dialog(const wxChar *title, const wxPoint &pos, const wxSize &size, const wxChar *staticImg)
				: wxDialog(NULL, -1, title, pos, size), logo(wxImage(staticImg, wxBITMAP_TYPE_PNG)) {
